...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output): void
    {
        ...
        $customerSet = $this->getContainer()->get('sylius.setup.customer_set')->setup($input, $output);
        $this->getContainer()->get('sylius.setup.channel')->setup($locale, $currency, $customerSet);
